...
namespace URLRedirection
{
    public class URLRedirectionMethods : IURLRedirectionMethods
    {
        ...
        public Dictionary<string, CultureConfiguration> GetCultureConfigurations(SiteInfo currentSite)
        {
            return CacheHelper.Cache(cs =>
            {
                ...
                var domainAliases = SiteDomainAliasInfo.Provider.Get()
                    ...
                    .Columns(nameof(SiteDomainAliasInfo.SiteID), nameof(SiteDomainAliasInfo.SiteDomainAliasName), nameof(SiteDomainAliasInfo.SiteDefaultVisitorCulture)).ToList();
        ...
        /// <returns></returns>
        public Dictionary<string, List<RedirectionEntry>> GetRedirectionEntries(int SiteID)
        {
            return CacheHelper.Cache(cs =>
            {
                ...
                foreach (RedirectionTableInfo TableEntry in RedirectionTableInfo.Provider.Get()
        ...
        public List<string> GetSiteCultures(int siteID)
        {
            return CacheHelper.Cache(cs =>
            {
                if (cs.Cached)
        ...
        public CMS.Localization.CultureInfo GetKenticoCulture(string currentCulture)
        {
            return CacheHelper.Cache(cs =>
            {
                if (cs.Cached)
                ...
                return CultureInfo.Provider.Get(currentCulture);
